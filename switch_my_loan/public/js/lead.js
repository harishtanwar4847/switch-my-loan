frappe.ui.form.on('Lead', {
	refresh: function(frm) {
        ...
        if(!frm.is_new() && (frappe.user_roles.includes('CRM User') || frappe.user_roles.includes('Partner User')) && !frappe.user_roles.includes('Sales User') && !frappe.user_roles.includes('Sales Manager') && frm.doc.source != 'Website' && frm.doc.source != 'Website WhatsApp BOT' && frm.doc.partner != "Basic Home Loan"){
